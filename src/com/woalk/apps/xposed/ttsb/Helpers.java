...
public final class Helpers {
	...
	public static void setTranslucentStatus(Activity activity, boolean on) {
		...
		if (on) winParams.flags |= WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS;
		else winParams.flags &= ~WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS;
	...
	public static void setTranslucentNavigation(Activity activity, boolean on) {
		Window win = activity.getWindow();
		WindowManager.LayoutParams winParams = win.getAttributes();
		if (on) winParams.flags |= WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION;
		else winParams.flags &= ~WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION;
		win.setAttributes(winParams);
	}
	...
	public static void logContentView(View parent, String indent) {
		...
		String isCnt = "";
		if (parent == content) isCnt = " (ContentView)";
	    XposedBridge.log(">TTSB [VIEWTEST] " + indent + parent.getClass().getName() + isCnt);
