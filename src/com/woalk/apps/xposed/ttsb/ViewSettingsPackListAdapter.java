...
public class ViewSettingsPackListAdapter extends ArrayAdapter<Settings.Setting.ViewSettingsPack> {
	
	public final Activity context;
	public List<Settings.Setting.ViewSettingsPack> vsetpks;

	public ViewSettingsPackListAdapter(Activity context, List<Settings.Setting.ViewSettingsPack> vsetpks) {
