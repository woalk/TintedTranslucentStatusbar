...
public class ViewSettingsDialog extends DialogFragment {
	...
	public ViewSettingsDialog(Settings.Setting.ViewSettings vset) {
		if (vset != null) this.vset = vset;
		else this.vset = new Settings.Setting.ViewSettings();
	}
	...
	public void setViewSettingsDialogListener(ViewSettingsDialogListener listener) {
	           ...
	           .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
	               ...
	               public void onClick(DialogInterface dialog, int id) {
	            	   ...
	            	   if (checkPadding.isChecked()) {
	            		   ...
	            		   vset.padding.plus_nav_w = check_nav_w.isChecked();
	            	   } else {
	            		   vset.padding = null;
	            	   }
